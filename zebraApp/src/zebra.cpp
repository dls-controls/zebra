...
#define PC_OFF 0xA0
    ...
    { "PC_GATE_WIDLO",   0x13 + PC_OFF, 0 },
    { "PC_GATE_WIDHI",   0x14 + PC_OFF, 0 },
    { "PC_GATE_NGATELO", 0x15 + PC_OFF, 0 },
    ...
    { "PC_PULSE_WIDHI",  0x24 + PC_OFF, 0 },
    { "PC_PULSE_STEPLO", 0x25 + PC_OFF, 0 },
    { "PC_PULSE_STEPHI", 0x26 + PC_OFF, 0 },
    /* System settings */
#define SYS_OFF 0xF0
